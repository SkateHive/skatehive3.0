...
const body = [
  "Check my bet! 🎯",
  "https://skatehive.app/hivepredict/0e10e215-d97e-4de8-a9e1-b3833649a47c",
  "https://hivepredict.app/markets/fdd92ff4-e28e-4e2e-9963-5a24e2aafed7",
  "http://localhost:3000/hivepredict/auto-nrl-1ae0cf6c922a22a04066dcb480951336",
].join("\n");
...
assert.ok(
  !out.contentWithPlaceholders.includes("/hivepredict/0e10e215"),
