...
const OpenGraphPreview: React.FC<OpenGraphPreviewProps> = ({ url }) => {
  ...
  // Skip OpenGraph preview for the removed internal coin route (dead link,
  // would otherwise render a broken-page preview for old posts), Snapshot
  // URLs, game URLs, and Google Maps links since they're handled by specific components
  const shouldSkip =
