...
// Sourced verbatim from https://www.reactbits.dev/animations/target-cursor
// with only cosmetic changes:
//   - "use client" directive so Next's app router doesn't try to render it
//     on the server (it touches `window`).
//   - Left the inner logic untouched so future updates can be diffed
//     directly against the upstream ts-default variant.
//
// Only used on the /home route (HomeMagazineClient mounts it there).
